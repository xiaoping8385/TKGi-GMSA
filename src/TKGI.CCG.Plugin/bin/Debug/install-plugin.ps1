...
mkdir "C:\Program Files\TKGICCGPlugin" -Force
copy TKGi.CCG.Plugin.dll "C:\Program Files\TKGICCGPlugin\"

& "C:\Windows\Microsoft.NET\Framework64\v4.0.30319\regsvcs" /fc "C:\Program Files\TKGICCGPlugin\TKGi.CCG.Plugin.dll"
...
$apps.Populate()
$app = $apps | Where-Object {$_.Name -eq "TKGi.CCG.Plugin"}
